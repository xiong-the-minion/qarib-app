...
import TranscriptionsIcon from '/src/assets/icons/transcriptions.svg?react';
import TagsIcon from '/src/assets/icons/tags.svg?react';
import ProjectsIcon from '/src/assets/icons/projects.svg?react';
import FavouritesIcon from '/src/assets/icons/favourites.svg?react';
...
import ToggleSidebarIcon from '/src/assets/icons/toggle-sidebar.svg?react';
...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onToggle }) => {
  ...
  const getIcon = (iconName: string, className: string = 'w-5 h-5', color: string = '#6B7280') => {
    ...
    switch (iconName) {
      ...
      case 'toggle-sidebar': return <ToggleSidebarIcon {...iconProps} />;
          ...
          <div className="p-4 pb-2 ">
            <div className="flex items-center justify-between mb-6">
              ...
              <button className="p-2 hover:bg-gray-100 rounded-lg">
                {getIcon('toggle-sidebar', 'w-5 h-5')}
              </button>
            </div>
