...
class TranscriptSerializer(serializers.ModelSerializer):
    ...
    def get_tags(self, obj):
        ...
        return [TagSerializer(transcript_tag.tag).data for transcript_tag in obj.transcript_tags.all()]
...
class TranscriptListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'status', 'tags', 'speaker_count', 'speakers'
        ]
    ...
    def get_speakers(self, obj):
        """Get speakers list for this transcript"""
